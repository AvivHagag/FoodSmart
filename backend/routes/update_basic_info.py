...
def update_basic_info():
    ...
    update_data = {"fullname": fullname, "email": email}
    ...
    result = mongo.db.users.update_one({"_id": user_oid}, {"$set": update_data})
    ...
    if updated_user:
        ...
        return jsonify({"message": "User information updated successfully", "user": updated_user}), 200
